# Day 07 — prototype design submission

## Requirement

Describe the prototype/admin design and the minimum screens needed to implement it.
...
1. Confirm the design defines landing/input, atlas result, recommendation detail, and completion states.
2. Confirm components, tokens, responsive collapse, keyboard focus, reduced motion, and non-color atlas meaning are specified.
3. Compare desktop and 360 px screenshots after implementation; record differences from the source direction log.

## Mock disclosure

The design intentionally covers a narrow course slice. Social, reviews, live data, production authentication, and sharing are outside this submission.
